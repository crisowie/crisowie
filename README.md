# 👋 Hey there, I'm **Crisowie**

🎯 A passionate **Fullstack Developer**, building powerful and scalable web apps with **Next.js**, **Node.js**, **Express**, **Supabase**, and **MongoDB**.  
I love turning ideas into full-fledged digital products and exploring new technologies that make web development more efficient and fun. 🚀  
...
- 🧩 Currently working on an **AI powered tutor web application**
- 🌱 Learning **DevOps** and **Cloud Deployment**
- 🧰 Main Stack: **React.js | Next.js | Node.js | Supabase | MongoDB | PostgreSQL**
- 🎯 Goal: Build my own software company that powers global online and revolutionize edtech
- ⚡ Fun fact: I’ve built 20+ projects from scratch 😎
...
### 🛒 **Acadex — AI Powered tutor web application**
> A fullstack web app where students and researchers students get to study faster and smater 
**Tech Stack: React.js, Node.js, Express, Supabase, TypeScript 
🔗 [https://otax.net](https://acadex-tutor-ai.vercel.app)
---

### 💰 **Expense Tracker App**
> A personal finance manager that lets users register, log in, and track expenses with authentication and protected dashboard routes.  
**Tech:** React, Node.js, Express, MongoDB, JWT  
🔗 [View Repository](https://github.com/crisowie/expense-tracker)
...
> Building impactful products, one project at a time 💻
